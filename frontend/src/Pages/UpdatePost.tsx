    ...
    <div className="p-3 max-w-3xl mx-auto min-h-[calc(90vh-100px)]">
      ...
      <form ref={formRef} className="flex flex-col gap-4" onSubmit={handleSubmitForm}>
        ...
        <div className="flex flex-col gap-4 sm:flex-row justify-between">
            ...
            <Select id="category" required onChange={(e) => setFormData({...formData, category: e.target.value})} value={formData.category}>
        ...
        <div className="flex flex-col gap-4">
            <ReactQuill className="bg-white h-[250px] mb-12" theme="snow" placeholder="Write Your Post Here..." modules={modules} formats={formats} onChange={(e) => setFormData({...formData, content: e})} value={formData.content} />
        </div>
        {/* ? TEXT INPUT END ? */}

        <Button type="submit" color="blue" className="mt-6">UPDATE POST</Button>
